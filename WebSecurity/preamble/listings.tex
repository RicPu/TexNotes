...
\NewDocumentCommand{\sqlicon}{O{1em}}{
  \raisebox{-0.2\height}{\includegraphics[height=#1]{assets/sql}}
}

\NewDocumentCommand{\phpicon}{O{1em}}{
  \raisebox{-0.2\height}{\includegraphics[height=#1]{assets/php}}
}
...
\newtcblisting{phpcode}[1][]{
  listing only,
  listing options={style=phpstyle},
  colback=codebg,
  colframe=codeframe,
  coltitle=black,
  fonttitle=\footnotesize\ttfamily,
