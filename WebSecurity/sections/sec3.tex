...
\subsubsection{Task 1 - Dictionary-Based Brute-Force}
Attack the Brute-Force section of the DVWA at easy and medium levels by performing a dictionary attack. For each level, you are required to retrieve the passwords for the users: \NewTexttt{pablo}, \NewTexttt{admin}, \NewTexttt{1337}, \NewTexttt{gordonb}, and \NewTexttt{smithy}. For good password sets, check: \url{https://github.com/danielmiessler/SecLists/tree/master/Passwords/Common-Credentials}